...
import { IsString, IsNotEmpty, IsUrl, IsInt, Min, Max, IsOptional } from 'class-validator';
...
export class CreateMemecoinDto {
  ...
  @ApiProperty({
    description: 'URL of the memecoin image',
  ...
  @ApiProperty({
    ...
    example: 'A fun coin based on Doge meme.',
  })
  @IsString()
  @IsNotEmpty()
  desc: string;
  ...
  @ApiProperty({
    description: 'X (Twitter) social link',
    example: 'https://x.com/dogecoin',
  })
  @IsUrl()
  @IsNotEmpty()
  @IsOptional()
  ...
  @ApiProperty({
    description: 'Telegram social link',
    example: 'https://t.me/dogecoin',
  })
  @IsUrl()
  @IsNotEmpty()
  @IsOptional()
  ...
  @ApiProperty({
    ...
    example: 'https://discord.gg/dogecoin',
  })
  @IsUrl()
  @IsNotEmpty()
  @IsOptional()
